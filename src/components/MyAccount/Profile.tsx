  ...
  const handleSave = async () => {
    try {
      ...
      Object.keys(formData).forEach(key => {
        if (key === 'address') {
          ...
          if (formData.address) {
            Object.keys(formData.address).forEach(addressKey => {
              if (formData.address?.[addressKey as keyof IAddress] !== originalData.address[addressKey as keyof IAddress]) {
                addressChanges[addressKey] = formData?.address?.[addressKey as keyof IAddress];
              }
            });
          }
        ...
        } else if (formData[key as keyof typeof formData] !== originalData[key as keyof typeof originalData]) {
      ...
      if (Object.keys(changedData).length > 0) {
        await AsyncUpdateProfile(changedData);
        ...
        <Grid container spacing={3}>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="First Name"
                      value={isEditing ? formData.firstName : appUser?.firstName || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="Last Name"
                      value={isEditing ? formData.lastName : appUser?.lastName || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      label="Date of Birth"
                      type="date"
                      value={appUser?.dob ? new Date(appUser.dob).toISOString().split('T')[0] : ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="Occupation"
                      value={isEditing ? formData.occupation : appUser?.occupation || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="Company"
                      value={isEditing ? formData.company : appUser?.company || ''}
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12}>
                    <TextField
                      ...
                      value={isEditing ? formData?.address?.address1 : appUser?.address?.address1 || ''}
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      value={isEditing ? formData?.address?.address2 : appUser?.address?.address2 || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="City"
                      value={isEditing ? formData?.address?.city : appUser?.address?.city || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="State"
                      value={isEditing ? formData?.address?.state : appUser?.address?.state || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="ZIP Code"
                      value={isEditing ? formData?.address?.postalCode : appUser?.address?.postalCode || ''}
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      size="small"
                      label="Country"
                      value={isEditing ? formData?.address?.country : appUser?.address?.country || ''}
          ...
          <Grid item xs={12} lg={4}>
            <Paper elevation={1} sx={{ width: '100%', mb: 3 }}>
              ...
              <Box sx={{ p: 3 }}>
                <Box display="flex" alignItems="center" gap={2} sx={{ mb: 3 }}>
                  <SecurityIcon sx={{ color: Colors.raspberry, fontSize: 24 }} />
                  <Typography variant="h6" fontWeight={600} color={Colors.blue}>
                    Security Settings
                  </Typography>
                </Box>
            ...
            <Paper elevation={1} sx={{ width: '100%' }}>
              ...
              <Box sx={{ p: 3 }}>
                ...
                <Box display="flex" alignItems="center" gap={2} sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 2 }}>
                  <FaCcMastercard style={{ fontSize: '32px', color: Colors.blue }} />
                  <Box>
                    <Typography variant="body2" fontWeight={600}>Mastercard</Typography>
                    <Typography variant="caption" color="text.secondary">•••• •••• •••• 1234</Typography>
                  </Box>
                  <Chip label="Primary" size="small" color="primary" sx={{ ml: 'auto' }} />
                </Box>
