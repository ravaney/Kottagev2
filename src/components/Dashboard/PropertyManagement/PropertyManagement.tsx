...
export default function PropertyManagement() {
  ...
  const handleAddProperty = () => {
    ...
    if (isSubdomain('host')) {
      navigate('/dashboard/properties/add-property');
    } else {
                ...
                reviews={[
                  {
                    ...
                    rating: 4.5,
                    comment:
                      'Beautiful property with amazing views! The beach access was perfect and the house was very clean. Would definitely stay again.',
                    date: 'Jun 10, 2023',
                    flagged: false,
                  },
                  {
                    ...
                    rating: 2.5,
                    comment:
                      "The location was nice but the property wasn't very clean. There were issues with the bathroom and the cleanliness was below our expectations.",
                    date: 'Jun 5, 2023',
                    flagged: true,
                  ...
                  },
                  {
                    ...
                    rating: 5.0,
                    comment:
                      'Perfect location in the heart of the city! The apartment was spotless and had everything we needed. The host was very responsive and helpful.',
                    date: 'May 28, 2023',
                    flagged: false,
                  },
                ]}
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <CalendarSyncCard
                ...
                onToggleAutoSync={(id, autoSync) =>
                  console.log(`Toggle auto sync for ${id}: ${autoSync}`)
                }
