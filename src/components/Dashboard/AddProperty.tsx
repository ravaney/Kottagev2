...
export default function AddProperty() {
  ...
  const validateStep2 = (): boolean => {
    const hasValidBasePrice = propertyData.price && propertyData.price > 0;
  ...
  const getStepErrors = (): string[] => {
    ...
    switch (activeStep) {
      ...
      case 1:
        ...
        break;
      case 2:
        if (!propertyData.price || propertyData.price <= 0) errors.push('Base price must be greater than 0');
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    <TextField
                      fullWidth
                      type="number"
                      label="Base Price per Night (JMD)"
