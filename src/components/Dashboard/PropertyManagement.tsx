...
export default function PropertyManagement() {
  ...
  const lowAvailabilityAlerts = [
    { id: '1', propertyName: 'Beach House', roomType: 'Deluxe Suite', availableUnits: 1, totalUnits: 5, dates: 'Jul 15 - Jul 20, 2023' },
    { id: '2', propertyName: 'Mountain Cabin', roomType: 'Standard Room', availableUnits: 0, totalUnits: 3, dates: 'Jul 22 - Jul 28, 2023' },
